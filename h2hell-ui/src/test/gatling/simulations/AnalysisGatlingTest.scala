...
/**
 * Performance test for the Analysis entity.
 */
class AnalysisGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Analysis entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created analysis")
                .get("${new_analysis_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created analysis")
            .delete("${new_analysis_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
