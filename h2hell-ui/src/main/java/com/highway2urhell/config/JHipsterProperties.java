...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "h2hellUi@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "h2hellUi API";

        private String description = "h2hellUi API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "h2hellUi";
