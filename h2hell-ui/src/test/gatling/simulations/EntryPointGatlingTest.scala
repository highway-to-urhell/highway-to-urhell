...
/**
 * Performance test for the EntryPoint entity.
 */
class EntryPointGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the EntryPoint entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created entryPoint")
                .get("${new_entryPoint_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created entryPoint")
            .delete("${new_entryPoint_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
