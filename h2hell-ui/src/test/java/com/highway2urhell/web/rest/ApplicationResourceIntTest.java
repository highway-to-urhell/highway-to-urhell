...
public class ApplicationResourceIntTest {
    ...
    private static final Boolean DEFAULT_ANALYSIS = false;
    private static final Boolean UPDATED_ANALYSIS = true;
    ...
    public void initTest() {
        ...
        application.setAnalysis(DEFAULT_ANALYSIS);
    }
    ...
    public void createApplication() throws Exception {
        ...
        assertThat(testApplication.isAnalysis()).isEqualTo(DEFAULT_ANALYSIS);
    }
    ...
    public void getAllApplications() throws Exception {
        ...
        restApplicationMockMvc.perform(get("/api/applications?sort=id,desc"))
                ...
                .andExpect(jsonPath("$.[*].analysis").value(hasItem(DEFAULT_ANALYSIS.booleanValue())));
    }
    ...
    public void getApplication() throws Exception {
        ...
        restApplicationMockMvc.perform(get("/api/applications/{id}", application.getId()))
            ...
            .andExpect(jsonPath("$.analysis").value(DEFAULT_ANALYSIS.booleanValue()));
    }
    ...
    public void updateApplication() throws Exception {
        ...
        updatedApplication.setAnalysis(UPDATED_ANALYSIS);
        ...
        assertThat(testApplication.isAnalysis()).isEqualTo(UPDATED_ANALYSIS);
    }
